            ...
            <div className="bg-gradient-to-r from-blue-50 to-blue-300 flex items-center justify-center min-h-screen">
                <div className="lg:w-96 w-80 mb-32 p-6 shadow-2xl border-4 mt-2 border-gray-700 bg-white rounded-xl">
                    ...
                    <form onSubmit={handleSubmit} className="flex justify-center gap-3 items-center flex-col">
                        ...
                        <input onBlur={handleBlur} onChange={handleChange} value={values.title} name="title" className={`border-2 w-52 mb-2 shadow-2xl border-black focus:outline-none focus:border-blue-500 p-1 px-2 rounded-lg ${errors.title && 'border-red-500'}`} type="text" placeholder="Title..." />
                        ...
                        <textarea onBlur={handleBlur} onChange={handleChange} value={values.description} name="description" className={`border-2 mt-0 m-3 w-52 shadow-2xl border-black focus:outline-none focus:border-blue-500 p-1 px-2 rounded-lg ${errors.description && 'border-red-500'}`} id="description" cols="22" rows="3" placeholder="Description..."></textarea>
                        <div className="text-center gap-4 mb-2 flex items-center justify-center">
                            ...
                            <input type="button" onClick={chooseImageClick} className="p-1.5 cursor-pointer border-2 border-black bg-blue-600 hover:bg-blue-800 ease-in-out duration-150 rounded-lg text-white" value={fileTooLarge ? 'File Too Large' : selectedFile ? 'Image Selected' : 'Initial Image'} />
                        </div>
                        ...
                        <input onBlur={handleBlur} onChange={handleChange} value={values.eventType} name="eventType" className={`border-2 mb-2 w-52 shadow-2xl border-black focus:outline-none focus:border-blue-500 p-1 px-2 rounded-lg ${errors.eventType && 'border-red-500'}`} type="text" placeholder="Event Type..." />
                        {errors.ticketPrice && <div className="font-semibold text-red-500 text-center">Ticket price should be between 1$ and 9999$.</div>}
                        <input onBlur={handleBlur} onChange={handleChange} value={values.ticketPrice} name="ticketPrice" className={`border-2 w-52 mb-2 shadow-2xl border-black focus:outline-none focus:border-blue-500 p-1 px-2 rounded-lg ${errors.ticketPrice && 'border-red-500'}`} type="number" placeholder="Ticket Price..." />
