        ...
        <div className="text-white" style={backgroundImageStyle}>
            <div className="bg-gradient-to-r from-black">
                <div className="lg:w-1/2 w-11/12 lg:ml-10 ml-4 grid grid-cols-1 gap-4">
                    ...
                    <button onClick={() => navigate('/events')} className="rounded-lg h-12 w-32 mb-14 mt-2 font-semibold bg-gradient-to-r from-[#20B486] to-[#148b65] hover:bg-gradient-to-r  py-3 px-4 hover:from-[#148b65] hover:to-[#20B486]">View Events</button>
                </div>
            </div>
        </div>
    )
